...
# use the head or the tail function - specify the number of rows and assign that to the vehicleTable so it only includes the top 10 or so - once it's ordered
